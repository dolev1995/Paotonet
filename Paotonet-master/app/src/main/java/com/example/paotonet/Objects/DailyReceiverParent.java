...
public class DailyReceiverParent extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        Notification notification = notificationBuilder
                .setContentTitle("Health Declaration Reminder")
                .setSmallIcon(R.drawable.reminder_icon)
                .setContentText("Do not forget to sign the health declaration in case you sent your child to kindergarten")
